-- ============================================================
-- MIGRAÇÃO: Corrigir política RLS de UPDATE na tabela tickets
...
CREATE POLICY "Atualizar chamado"
  ...
  USING (
    ...
    -- 4. Ou o setor de destino do chamado está entre os setores vinculados ao usuário (membros do grupo de destino)
